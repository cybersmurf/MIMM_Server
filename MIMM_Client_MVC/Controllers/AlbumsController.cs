...
namespace MIMM_Client_MVC.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Idartist")] Albums albums)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Idartist")] Albums albums)
        {
            if (id != albums.Id)
            {
                return NotFound();
